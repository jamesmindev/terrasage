          ...
          <div className="legal-notice">
            ...
            <div className="section">
              ...
              <p>
                ...
                performance is not indicative of future results. Users should be
                aware that investments can fluctuate in value and that they may
            ...
            <div className="section">
              ...
              <p>
                While Terrasage focuses on environmentally friendly projects, it
                does not provide any warranty or guarantee regarding the
                environmental impact or sustainability of the investments. Users
          ...
          <div className="privacy-policy">
            ...
            <div className="section">
              ...
              <ul>
                ...
                <li>
                  <em>Usage Data</em>: We collect information about how you use
            ...
            <div className="section">
              ...
              <ul>
                ...
                <li>
                  <em>Communication</em>: To send you updates, newsletters, and
                  other communications related to our services. You can opt-out
            ...
            <div className="section">
              ...
              <ul>
                ...
                <li>
                  <em>Legal Requirements</em>: We may disclose your information
            ...
            <div className="section">
              ...
              <ul>
                ...
                <li>
                  <em>Deletion</em>: You have the right to request the deletion
